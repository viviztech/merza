                    ...
                    <div class="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
                        ...
                        <div class="space-y-3 text-sm">
                            ...
                            <div class="flex items-center gap-3">
                                ...
                                <a href="tel:+919360064278" class="text-emerald-200 hover:text-white transition-colors">+91 93600 64278</a>
                            </div>
                            <div class="flex items-center gap-3">
                        ...
                        <div class="mt-5 flex flex-col sm:flex-row gap-3">
                            ...
                            <a href="https://wa.me/919360064278?text=Hi%2C+I+want+to+visit+your+store+or+place+an+order!" target="_blank"
