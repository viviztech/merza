        ...
        <div class="grid md:grid-cols-2 gap-12 items-center">
            <div>
                ...
                <p class="text-stone-600 leading-relaxed mb-4">
                    We partner directly with trusted farms across India and Southeast Asia to source only the finest seasonal fruits — no middlemen, no compromise on quality.
                </p>
            ...
            <div class="grid grid-cols-2 gap-4">
                @foreach([
                    ...
                    ['🚚', 'Fast Delivery', 'Local and nearby delivery within 1–2 days.'],
                ] as [$icon, $title, $desc])
    ...
    <section class="bg-emerald-900 text-white py-14 px-4">
        <div class="max-w-xl mx-auto text-center">
            ...
            <div class="flex flex-col sm:flex-row gap-3 justify-center">
                ...
                <a href="https://wa.me/918667696278?text=Hi%2C+I%27d+like+to+know+more+about+Merza!"
                   target="_blank"
