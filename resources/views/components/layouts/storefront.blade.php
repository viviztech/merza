        ...
        <div x-show="mobileOpen"
            ...
            <nav class="px-3 py-3 space-y-0.5">
                ...
                <a href="{{ route('contact') }}" @click="mobileOpen = false"
                   class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-semibold transition-colors
                          {{ request()->routeIs('contact') ? 'bg-amber-50 text-brand-green-dark' : 'text-stone-700 hover:bg-stone-50' }}">
            ...
            <div class="grid md:grid-cols-4 gap-8 mb-8">
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-sm">
                        ...
                        <li><a href="{{ route('contact') }}" class="text-emerald-300 hover:text-amber-400 transition-colors">Contact Us</a></li>
