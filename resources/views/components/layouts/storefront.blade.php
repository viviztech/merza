...
<body class="bg-white font-sans antialiased text-stone-900 pb-20 md:pb-0">
    ...
    <a href="https://wa.me/919360064278?text=Hi%2C%20I%20want%20to%20order%20from%20Merza!"
       target="_blank"
       class="flex fixed bottom-24 md:bottom-6 left-4 md:left-6 z-50 bg-green-500 hover:bg-green-400 text-white rounded-2xl w-13 h-13 md:w-14 md:h-14 items-center justify-center shadow-xl transition-all hover:scale-110 hover:shadow-2xl"
