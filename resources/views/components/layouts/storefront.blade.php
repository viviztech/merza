...
<body class="bg-gray-50 font-sans antialiased text-gray-900 pb-20 md:pb-0">
    ...
    <header class="sticky top-0 z-40 bg-white border-b border-gray-100 shadow-sm">
        <div class="max-w-7xl mx-auto px-4 h-14 flex items-center justify-between">
            ...
            <div class="flex items-center gap-3">
                ...
                {{-- Cart (badge updates live via Alpine when cart-updated fires) --}}
                <a href="{{ route('cart.index') }}"
                   ...
                   class="relative p-2 text-gray-600 hover:text-green-700 transition-colors">
    ...
    <footer class="hidden md:block bg-green-900 text-white mt-16">
        <div class="max-w-7xl mx-auto px-4 py-10 grid grid-cols-4 gap-8">
            ...
            <div>
                ...
                <a href="https://wa.me/60123456789" class="inline-flex items-center gap-2 bg-green-600 hover:bg-green-500 text-white text-sm font-medium px-4 py-2 rounded-lg transition-colors">
    ...
    <nav class="md:hidden fixed bottom-0 left-0 right-0 z-40 bg-white border-t border-gray-200 safe-area-pb">
        <div class="grid grid-cols-5 h-16">
            ...
            <a href="https://wa.me/60123456789" target="_blank" class="flex flex-col items-center justify-center gap-1 text-xs text-gray-400 hover:text-green-700 transition-colors">
    ...
    <a href="https://wa.me/60123456789?text=Hi%2C%20I%20want%20to%20order%20from%20Merza!"
       target="_blank"
